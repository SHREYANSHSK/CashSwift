...
class _home_PageState extends State<home_Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection("users").doc(widget.PHONE_NUMBER).snapshots(),
        builder: (context,snapshot) {
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child:  Row(
                                        children: [
                                          Icon(Icons.qr_code),
                                          Text("UPI ID: ${snapshot.data!["phoneNumber"]}@CodeSwift"),
                                        ],
                                      ),
                                    ),
                                  ],
          ...
          else{return Text("Error occured");}
        }
      ),
